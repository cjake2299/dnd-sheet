...
namespace Sheet
{
    class SpecialQuilityInfo
    {
        ...
        public void LoadFeatData(string path)
        {
            ...
            #region 특수능력 이름 얻기
            node = root.SelectSingleNode("/SpecialQuility/Name/" + Setting.instance.Language);
            ...
            #region 특수능력 설명 얻기
            node = root.SelectSingleNode("/SpecialQuility/Description/" + Setting.instance.Language);
